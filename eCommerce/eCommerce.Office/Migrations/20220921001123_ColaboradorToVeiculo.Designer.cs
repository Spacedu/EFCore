...
namespace eCommerce.Office.Migrations
{
    ...
    [Migration("20220921001123_ColaboradorToVeiculo")]
            ...
            modelBuilder.Entity("eCommerce.Office.Models.ColaboradorSetor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SetorId = 1,
                            ColaboradorId = 1,
                            Criado = new DateTimeOffset(new DateTime(2022, 9, 20, 21, 11, 22, 276, DateTimeKind.Unspecified).AddTicks(6134), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 1,
                            ColaboradorId = 6,
                            Criado = new DateTimeOffset(new DateTime(2022, 9, 20, 21, 11, 22, 276, DateTimeKind.Unspecified).AddTicks(6193), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 2,
                            ColaboradorId = 5,
                            Criado = new DateTimeOffset(new DateTime(2022, 9, 20, 21, 11, 22, 276, DateTimeKind.Unspecified).AddTicks(6195), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 2,
                            ColaboradorId = 4,
                            Criado = new DateTimeOffset(new DateTime(2022, 9, 20, 21, 11, 22, 276, DateTimeKind.Unspecified).AddTicks(6198), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 3,
                            ColaboradorId = 7,
                            Criado = new DateTimeOffset(new DateTime(2022, 9, 20, 21, 11, 22, 276, DateTimeKind.Unspecified).AddTicks(6200), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 4,
                            ColaboradorId = 2,
                            Criado = new DateTimeOffset(new DateTime(2022, 9, 20, 21, 11, 22, 276, DateTimeKind.Unspecified).AddTicks(6206), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 4,
                            ColaboradorId = 3,
                            Criado = new DateTimeOffset(new DateTime(2022, 9, 20, 21, 11, 22, 276, DateTimeKind.Unspecified).AddTicks(6209), new TimeSpan(0, -3, 0, 0, 0))
                        });
                });
