...
namespace eCommerce.Office.Migrations
{
    ...
    [Migration("20220920201134_BancoInicial")]
            ...
            modelBuilder.Entity("eCommerce.Office.Models.ColaboradorSetor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SetorId = 1,
                            ColaboradorId = 1,
                            Criado = new DateTimeOffset(new DateTime(2022, 9, 20, 17, 11, 33, 517, DateTimeKind.Unspecified).AddTicks(4229), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 1,
                            ColaboradorId = 6,
                            Criado = new DateTimeOffset(new DateTime(2022, 9, 20, 17, 11, 33, 517, DateTimeKind.Unspecified).AddTicks(4288), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 2,
                            ColaboradorId = 5,
                            Criado = new DateTimeOffset(new DateTime(2022, 9, 20, 17, 11, 33, 517, DateTimeKind.Unspecified).AddTicks(4291), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 2,
                            ColaboradorId = 4,
                            Criado = new DateTimeOffset(new DateTime(2022, 9, 20, 17, 11, 33, 517, DateTimeKind.Unspecified).AddTicks(4293), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 3,
                            ColaboradorId = 7,
                            Criado = new DateTimeOffset(new DateTime(2022, 9, 20, 17, 11, 33, 517, DateTimeKind.Unspecified).AddTicks(4296), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 4,
                            ColaboradorId = 2,
                            Criado = new DateTimeOffset(new DateTime(2022, 9, 20, 17, 11, 33, 517, DateTimeKind.Unspecified).AddTicks(4298), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 4,
                            ColaboradorId = 3,
                            Criado = new DateTimeOffset(new DateTime(2022, 9, 20, 17, 11, 33, 517, DateTimeKind.Unspecified).AddTicks(4301), new TimeSpan(0, -3, 0, 0, 0))
                        });
                });
